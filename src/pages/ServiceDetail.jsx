    ...
    <div className="container-fluid p-0">
        <div className="row g-0 p-0 align">
                ...
                <div className="container-fluid w-100 p-0 serviceDescription px-2">
                    <div className="row d-flex align-items-center justify-content-center pt-3">
                        <div className="d-flex align-items-center position-relative">
                            ...
                            <span className="fs-2 flex-grow-1 text-center">{service.title}</span>
                        </div>
                    </div>
            ...
            <div className="col-lg-6 p-4 serviceBooking">
                <h2 className="text-white text-center mb-4">Book {service.title}</h2>
                ...
                <div className="serviceDescription rounded p-4 serviceDetails">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="email" className="form-control" placeholder="john.doe@sample.com" />
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="card">
                            <div className="card-body p-4">
                                <div className="btn-group w-100 mb-4" role="group">
                                    <button
                                        type="button"
                                        className={`btn ${activeTab === 'dropoff' ? 'backButton' : 'btn-outline-secondary'}`}
                                    ...
                                    <button
                                        type="button"
                                        className={`btn ${activeTab === 'pickup' ? 'backButton' : 'btn-outline-secondary'}`}
                                ...
                                {activeTab === 'dropoff' && (
                                    <div>
                                        <div className="mb-3">
                                            <label className="form-label">Preferred Drop-off Date</label>
                                            <input
                                                type="date"
                                        ...
                                        <div className="mb-3">
                                            <label className="form-label">Preferred Drop-off Time Slot</label>
                                            <select
                                ...
                                {activeTab === 'pickup' && (
                                    <div>
                                        <div className="mb-3">
                                            <label className="form-label">Preferred Pick-up Date</label>
                                            <input
                                                type="date"
                                                className="form-control"
                                                value={pickupDate}
                                            ...
                                            {dropoffDate && (
                                                <div className="form-text">
                                                    Minimum pick-up date is {turnaroundDays} days after drop-off
                                                </div>
                                            )}
                                        </div>
                                        
                                        <div className="mb-3">
                                            <label className="form-label">Preferred Pick-up Time Slot</label>
                                            <select
                                                className="form-select"
                                                value={pickupTime}
                        ...
                        <div className="mt-3 p-3 bg-white rounded">
                            <small className="text-muted">
                                <strong>Our hours:</strong> Mon-Fri 9 AM - 6 PM, Sat 10 AM - 4 PM. Sunday closed.<br/>
                                Pick-up is at least {turnaroundDays} days after drop-off for this service.
                            </small>
                        </div>
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <textarea className="form-control" rows="3" placeholder="Rolex Submariner not winding, needs crystal replacement."></textarea>
                    </div>
                    ...
                    {(dropoffDate || pickupDate) && (
                        <div className="mb-4 p-3 border rounded">
                            ...
                            {dropoffDate && (
                                <div><strong>Drop-off:</strong> {dropoffDate} {dropoffTime && `at ${dropoffTime}`}</div>
                            )}
                            {pickupDate && (
                                <div><strong>Pick-up:</strong> {pickupDate} {pickupTime && `at ${pickupTime}`}</div>
                            )}
                        </div>
                    )}
                    ...
                    <div className="row justify-content-center">
                        <div className="col-12 col-lg-4">
                            <button className="btn w-100 backButton" onClick={buttonClick}>Submit</button>
                        </div>
                    </div>
